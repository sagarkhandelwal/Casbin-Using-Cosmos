...
using CasbinRBAC.Domain.Extensions;
...
namespace CasbinRBAC.Persistance
{
    ...
    {
        public CasbinDbAdapter(CasbinDbContext<TKey> context) : base(context)
        {

        }
    }

    public class CasbinDbAdapter<TKey, TCasbinRule> : CasbinDbAdapter<TKey, TCasbinRule, CasbinDbContext<TKey>>
